...
@Component({
  ...
  styleUrl: "./print-purchase-order.component.css",
...
export class PrintPurchaseOrderComponent {
    ...
    try {
      ...
      const docDefinition = {
        ...
        content: [
          ...
          {
            text: `Purchase order #: ${this.po.reference}`,
            alignment: "right",
            fontSize: 12,
            bold: true,
          },
          ...
          { text: "", margin: [0, 30, 0, 0] },
          {
            columns: [
              [
                ...
                {
                  text: this.po.vendor.name,
                  margin: [0, 5, 0, 0],
                  fontSize: 9,
                  bold: true,
                },
                { text: this.po.vendor.email, fontSize: 9, bold: true },
                { text: this.po.vendor.address, fontSize: 9, bold: true },
                { text: this.po.vendor.phone, fontSize: 9, bold: true },
              ],
              [
                {
                  stack: [
  ...
  calculateVATAmount(): number {
    if (this.po.discount_status) {
      ...
      return (
        (this.calculateTotalWithouxVAT() + this.po.shipping_amount) * 0.1925
      );
    }
  }
